...
public enum ButtonNameEnum {
    ...
    DOCLIST("Список неоходимых документов"),
    TRANSP("Рекомендации по транспортировке"),
    HOMESML("Рекомендаций по обустройству дома щенка"),
    HOMEBIG("Рекомендаций по обустройству дома взрослого животного"),
    HOME("Рекомендаций по обустройству дома животного сограниченными возможностями"),
